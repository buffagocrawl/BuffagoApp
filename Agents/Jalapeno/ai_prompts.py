...
def build_text_generation_prompt(
    *,
    ...
    return (
        ...
        "- Make it sound naturally shareable with prompts like Send this to..., Tag..., Share this with..., Comment..., Save this..., or Make plans...\n"
        "- Use exactly one of these caption styles as the lane for the caption:\n"
        f"{_caption_style_system_text()}\n"
        "- Also generate image-text logic that would pair cleanly with the caption even if the image-text field is stored elsewhere\n"

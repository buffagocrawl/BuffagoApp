...
- Any-activity DAU: **12** (the current daily aggregate cannot safely calculate WAU/MAU).
...
Machine-readable: `Buffago/metrics/latest.json` and `Buffago/metrics/daily/2026-07-27.json`.

...
- Any-activity DAU: **3** (the current daily aggregate cannot safely calculate WAU/MAU).
...
- Ratings created: **20**; crawls created: **20**; Wing Duel votes: **0**.
...
Machine-readable: `Buffago/metrics/latest.json` and `Buffago/metrics/daily/2026-07-30.json`.

...
- Any-activity DAU: **1** (the current daily aggregate cannot safely calculate WAU/MAU).
...
Machine-readable: `Buffago/metrics/latest.json` and `Buffago/metrics/daily/2026-09-04.json`.

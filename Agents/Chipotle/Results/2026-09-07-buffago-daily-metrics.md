...
- Any-activity DAU: **2** (the current daily aggregate cannot safely calculate WAU/MAU).
...
Machine-readable: `Buffago/metrics/latest.json` and `Buffago/metrics/daily/2026-09-07.json`.

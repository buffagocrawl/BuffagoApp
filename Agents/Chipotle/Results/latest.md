...
- Any-activity DAU: **15** (the current daily aggregate cannot safely calculate WAU/MAU).
...
Machine-readable: `Buffago/metrics/latest.json` and `Buffago/metrics/daily/2026-07-26.json`.

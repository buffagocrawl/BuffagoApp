...
- Any-activity DAU: **22** (the current daily aggregate cannot safely calculate WAU/MAU).
...
- Ratings created: **1**; crawls created: **1**; Wing Duel votes: **0**.
...
Machine-readable: `Buffago/metrics/latest.json` and `Buffago/metrics/daily/2026-07-25.json`.
